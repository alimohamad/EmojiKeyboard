...
var map = {16 : false, 18: false, 66: false, 70: false, 76: false, 80: false, 76: false};
...
window.addEventListener('keydown', function(e) {   
    ...
    if (e.keyCode in map) {
        ...
        if (map[70] && map[16] && map[18]) {
            console.log('¯\\\_(ツ)_/¯');
        }

        else if(map[83] && map[16] && map[18]){
            console.log('🤔');
        } 

        else if(map[76] && map[16] && map[18]){
            console.log('👀');
        }

        else if(map[80] && map[16] && map[18]){
            console.log('💩');
        }

        else if(map[66] && map[16] && map[18]){
            console.log('🅱');
        }   
